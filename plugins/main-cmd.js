...
console.log(`TASHINDU-MD ♻ Auto Bio Started`);
//============================ Env=======================================================
...
async (conn, mek, m, { from, contextInfo, reply }) => {
    try {
        ...
        let envSettings = `╭━━━〔 *TASHINDU-MD-ENV* 〕━━━┈⊷
┃▸╭───────────
┃▸┃๏ *𝔼ℕ𝕍 𝕊𝔼𝕋𝕋𝕀ℕ𝔾𝕊 📡*
┃▸└───────────···๏
╰────────────────┈⊷
...
async (conn, mek, m, { from }) => {
    try {
        ...
        const ownerName = 'TASHINDU-MD'; // Replace this with the owner's name
        const organization = 'WTS CODERS'; // Optional: replace with the owner's organization
...
try{
    ...
    let ping = await conn.sendMessage(from , { text: '*_TASHINDU-MD..._*'  }, { quoted: mek } )
...
try{
let dec = `> TASHINDU-MD REPO INFO 🪀

╭⦁⦂⦁*━┉━┉━┉━┉━┉━┉━⦁⦂⦁
┃ 𝙾𝚆𝙽𝙴𝚁 𝙽𝚄𝙼𝙱𝙴𝚁: ${bot.OWNER_NUMBER}
┃ 
┃ TASHINDU-MD REPO: ${bot.REPO_LINK} 
┃
